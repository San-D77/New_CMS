...
#notfound .notfound,#notfound .notfound:after{-webkit-transform:translate(-50%, -50%);left:50%;top:50%;transform:translate(-50%, -50%);position:absolute;}
...
#notfound .notfound-bg{position:absolute;width:100%;height:100%;background:linear-gradient(to right, #4b4343, #3e4e4c 50%, #eee 100%)!important;}
#notfound .notfound-bg:after{content:'';position:absolute;width:100%;height:100%;background-color:rgba(0, 0, 0, .25);}
#notfound .notfound:after{content:'';width:100%;height:600px;background-color:rgba(255, 255, 255, .7);-webkit-box-shadow:0 0 0 30px rgba(255, 255, 255, .7) inset;box-shadow:0 0 0 30px rgba(255, 255, 255, .7) inset;z-index:-1;}
...
.notfound .notfound-404 h1{position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%, -50%);transform:translate(-50%, -50%);font-size:220px;margin:0;color:#222225;}
.notfound h2{font-size:26px;font-weight:500;color:#222225;margin-top:26px;margin-bottom:20px;}
.notfound a{display:inline-block;font-weight:400;background-color:transparent;color:#222225;font-size:14px;}
