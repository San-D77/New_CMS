<style>
				...
				blockquote {
								background: linear-gradient(to right, #9f9f9f, #c4c3c3 50%, #eee 100%) !important;
								font-style: italic;
								font-weight: 500;
								font-size: 1.15rem;
								margin: 25px;
				...
				blockquote::before {
								...
								bottom: 0;
								width: 6px;
								background: rgba(39, 37, 36, .8) !important;
								border-radius: 20px
				}
				...
				.contact form {
								border-radius: 4px;
								border: 1px solid rgba(0, 0, 0, .226);
								padding: 1rem
				}
				...
				.panel-title::before {
								...
								padding: 5px;
								background: rgba(127, 167, 181, .668);
								color: #484545;
								border-radius: 5px
				}

				.collapsed>span.panel-title::before {
								float: right !important;
								content: "Show";
								padding-right: 5px
				}
				...
				#notfound .notfound-bg {
								...
								width: 100%;
								height: 100%;
								background: linear-gradient(to right, #4b4343, #3e4e4c 50%, #eee 100%) !important
				}
				...
				.notfound-social .fa-facebook {
								color: #2374e1
				}

				.notfound-social .fa-pinterest {
								color: #b8321d
				}

				.notfound-social .fa-twitter {
								color: #1d9bf0
				}
				...
				.footer-section .subscribe-form button {
								...
								padding: 13px 20px;
								border: 1px solid #090234 !important;
								top: 0
				}
				...
				.category-segment {
								color: #fff;
								border-bottom: 3px solid #1e2129;
								margin: 0
				}

				.category-segment span {
				...
				.h-profile .main-grid .item .image figure .status {
								...
								padding-left: 1rem;
								width: 100%;
								background: -webkit-gradient(linear, left bottom, left top, from(rgba(0, 0, 0, .6)), color-stop(100%, rgba(0, 0, 0, 0)), to(rgba(0, 0, 0, 0)));
								background: linear-gradient(0deg, rgba(0, 0, 0, .6), rgba(0, 0, 0, 0) 100%, rgba(0, 0, 0, 0))
				}
				...
				@media (max-width:997px) {
								...
								.h-profile .main-grid .grid-item:first-child {
												-ms-grid-column: 1;
				...
				.popular .image .wrapper {
								...
								bottom: 0;
								width: 100%;
								background-image: -webkit-gradient(linear, left bottom, left top, from(rgba(0, 0, 0, .87)), color-stop(100%, rgba(0, 0, 0, 0)), to(rgba(0, 0, 0, .808)));
								background-image: linear-gradient(0deg, rgba(0, 0, 0, .87), rgba(0, 0, 0, 0) 100%, rgba(0, 0, 0, .808))
				}
