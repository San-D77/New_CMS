    ...
    public function index()
    {
        ...
        if($user->role->slug == 'super-admin'){
            return view('backend.pages.dashboard.index', [
                ...
                'todays_posts' => Article::where('task_status','published')->whereDate('created_at', '=', Carbon::today())->count(),
                'yesterday_posts' => Article::where('task_status','published')->whereDate('created_at', '=', Carbon::yesterday())->count(),
